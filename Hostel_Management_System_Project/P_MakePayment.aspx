<%@ Page Title="" Language="C#" MasterPageFile="~/ParentSite.Master" AutoEventWireup="true" CodeBehind="P_MakePayment.aspx.cs" Inherits="Hostel_Management_System_Project.P_MakePayment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-2">
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="P_ViewMyBooking.aspx">View My Bookings</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        function ShowSuccessAlert() {
            ...
            setTimeout(function () {
                console.log("Redirecting to Parent Payment History Page ...");
                window.location.href = 'P_ViewPaymentHistory.aspx';
            }, 2000);
        }
