...
namespace Hostel_Management_System_Project
{
    public partial class StudentRegister : System.Web.UI.Page
    {
        ...
        protected void btn_Signup_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                // Execute the stored procedure to insert the student into login_table
                SqlCommand cmd1 = new SqlCommand("sp_insert_student_login_table", con);
                ...
                SqlCommand cmd2 = new SqlCommand("sp_student_table_registration", con);
