<%@ Page Title="" Language="C#" MasterPageFile="~/ParentSite.Master" AutoEventWireup="true" CodeBehind="P_ViewAttendanceList.aspx.cs" Inherits="Hostel_Management_System_Project.P_ViewAttendanceList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Zafe HMS | Child Attendance Details
</asp:Content>
        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    Your Child's Hostel Attendance
                </div>
