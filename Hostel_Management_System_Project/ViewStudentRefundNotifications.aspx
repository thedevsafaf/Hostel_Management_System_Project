<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSite.Master" AutoEventWireup="true" CodeBehind="ViewStudentRefundNotifications.aspx.cs" Inherits="Hostel_Management_System_Project.ViewStudentRefundNotifications" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Zafe HMS - Student Refund Request Notifications
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <h2 class="text-light">Student Refund Requests</h2>
        <div class="row">
            <asp:Repeater ID="StudentRefundNotificationsRepeater" runat="server">
                <ItemTemplate>
