<%@ Page Title="" Language="C#" MasterPageFile="~/ParentSite.Master" AutoEventWireup="true" CodeBehind="P_ViewPaymentHistory.aspx.cs" Inherits="Hostel_Management_System_Project.P_ViewPaymentHistory" %>
        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    Parent <%= Session["name"] %>'s Payment History
                </div>
                        ...
                        <asp:Repeater ID="PaymentRepeater" runat="server">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td> <asp:Label ID="lbl_Status" runat="server" Text='<%# Eval("payment_status") %>' CssClass='<%# GetStatusCssClass(Eval("payment_status").ToString())+ " bold-status" %>'></asp:Label></td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
                                </tbody>
