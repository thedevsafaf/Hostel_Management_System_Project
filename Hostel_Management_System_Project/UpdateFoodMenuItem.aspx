<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSite.Master" AutoEventWireup="true" CodeBehind="UpdateFoodMenuItem.aspx.cs" Inherits="Hostel_Management_System_Project.UpdateFoodMenuItem" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Zafe HMS - Update Food Menu Item
</asp:Content>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-2">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Update Food Menu Item</h3></div>
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <div class="d-grid">
                                                <asp:Button ID="btn_UpdateFoodMenuItem" CssClass="btn btn-primary btn-block" runat="server" Text="Update Food Menu Item" OnClick="btn_UpdateFoodMenuItem_Click" />
                                            </div>
                                        </div>
                                    </div>
