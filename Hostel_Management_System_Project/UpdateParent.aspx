<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSite.Master" AutoEventWireup="true" CodeBehind="UpdateParent.aspx.cs" Inherits="Hostel_Management_System_Project.UpdateParent" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Zafe HMS - Update Parent
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-2">
                                    <div class="card-header">
                                        <h3 class="text-center font-weight-light my-4">Update Parent Account</h3>
                                    </div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="ViewParentsList.aspx">View Parents List</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        function ShowSuccessAlert() {
            ...
            setTimeout(function () {
                console.log("Redirecting to Parents List Page...");
