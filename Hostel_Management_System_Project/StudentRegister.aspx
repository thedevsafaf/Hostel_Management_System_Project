<%@ Page Title="" Language="C#" MasterPageFile="~/AuthSite.Master" AutoEventWireup="true" CodeBehind="StudentRegister.aspx.cs" Inherits="Hostel_Management_System_Project.StudentRegister" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Zafe HMS - Student SignUp
</asp:Content>
                ...
                <div class="col-lg-7">
                    <div class="card shadow-lg border-0 rounded-lg mt-2">
                        <div class="card-header">
                            <h3 class="text-center font-weight-light my-4">Create Student Account</h3>
                        </div>
                        <div class="card-body">
