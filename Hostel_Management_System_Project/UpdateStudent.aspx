<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSite.Master" AutoEventWireup="true" CodeBehind="UpdateStudent.aspx.cs" Inherits="Hostel_Management_System_Project.UpdateStudent" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Zafe HMS - Update Student
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-2">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Update Student Account</h3></div>
                                    <div class="card-body">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <label for="tb_Phone">Phone Number
                                            ...
                                            <div class="row mb-1">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <label for="tb_ConfirmPassword">Confirm Password
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="ViewStudentsList.aspx">View Students List</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        function ShowSuccessAlert() {
            ...
            setTimeout(function () {
                console.log("Redirecting to Students List Page...");
