<%@ Page Title="" Language="C#" MasterPageFile="~/ParentSite.Master" AutoEventWireup="true" CodeBehind="P_ViewAvailableRoomsList.aspx.cs" Inherits="Hostel_Management_System_Project.P_ViewAvailableRoomsList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Zafe HMS - Available Rooms
</asp:Content>
                ...
                <div class="card-body bg-dark">
                    <div class="table-responsive">
                       <!-- Search Box  -->
                        ...
                        <!-- Search Box -->
                        <asp:Repeater ID="AvailableRoomRepeater" runat="server">
                            <HeaderTemplate>
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <asp:HyperLink ID="lnk_RoomDetails" runat="server" NavigateUrl='<%# "P_RoomDetails.aspx?roomId=" + Eval("room_id") %>' Text='<%# Eval("room_no") %>' />
                                    </td>
