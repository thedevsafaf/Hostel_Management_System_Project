<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSite.Master" AutoEventWireup="true" CodeBehind="SendNotifications.aspx.cs" Inherits="Hostel_Management_System_Project.SendNotifications" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Zafe HMS - Send Notifications
</asp:Content>
                ...
                <div class="col-lg-7">
                    <div class="card shadow-lg border-0 rounded-lg mt-2">
                        <div class="card-header">
                            <h3 class="text-center font-weight-light my-4">Send Notifications</h3>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <asp:DropDownList ID="ddl_Recipient" runat="server" CssClass="form-control">
                                            <asp:ListItem Text="All Students" Value="Select All" />
                                            <asp:ListItem Text="Select Student" Value="Select Any Student" />
                                        </asp:DropDownList>
                                        <label for="ddl_Recipient">Select All for (Group Notifications) | Select Student for (Individual Notifications)</label>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-0">
    ...
    <script type="text/javascript">
        function ShowSuccessAlert() {
            Swal.fire({
                ...
                text: 'You have sent the notifications to Student/s successfully!',
